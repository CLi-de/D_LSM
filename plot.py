...
def plot_scatter(arr):
    ...
    '''draw lines'''
    L1 = plt.plot(x_, arr[:, 0], color="blue", linestyle=":", marker='o',
                  linewidth=1.5, label="L=1", markerfacecolor='blue', ms=7)
    L2 = plt.plot(x_, arr[:, 1], color="green", linestyle=":", marker='^',
                  linewidth=1.5, label="L=2", markerfacecolor='green', ms=8)
    L3 = plt.plot(x_, arr[:, 2], color="gold", linestyle=":", marker='s',
                  linewidth=1.5, label="L=3", markerfacecolor='gold', ms=7)
    L4 = plt.plot(x_, arr[:, 3], color="orange", linestyle=":", marker='p',
                  linewidth=1.5, label="L=4", markerfacecolor='orange', ms=9)
    L5 = plt.plot(x_, arr[:, 4], color="red", linestyle=":", marker='*',
                  linewidth=1.5, label="L=5", markerfacecolor='red', ms=10)
